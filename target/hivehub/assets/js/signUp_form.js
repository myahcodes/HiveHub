...
txt_email.onfocus = () => { click_audio.currentTime = 0; click_audio.play(); };
/*Full name field*/
const txt_name = document.createElement("input");
txt_name.type = "text";
txt_name.placeholder = "Name";
txt_name.onfocus = () => { click_audio.currentTime = 0; click_audio.play(); };
/*Username field*/
...
txt_username.onfocus = () => { click_audio.currentTime = 0; click_audio.play(); };
/*Password field*/
const txt_password = document.createElement("input");
txt_password.type = "password";
txt_password.placeholder = "Password";
txt_password.required = true;
txt_password.onfocus = () => { click_audio.currentTime = 0; click_audio.play(); };
...
/*Sign Up — sends data to RegisterServlet then redirects to Login*/
